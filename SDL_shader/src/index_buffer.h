...
// void SDL_GL_BindIndexBuffer(/*SDL_GL_VertexArray* vertex_array,*/ SDL_GL_IndexBuffer* buffer);
// void SDL_GL_UnbindIndexBuffer(/*SDL_GL_VertexArray* vertex_array, SDL_GL_IndexBuffer* buffer*/);
